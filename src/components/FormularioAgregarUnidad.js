...
function FormularioAgregarUnidad(props) {
        ...
        <div className="Formulario-container lightGlass">
            <form action="" className="formulario" onSubmit={showModal}>
                <div className="item-formulario">
                    ...
                    <input type="text" className="inputDarkGlass manrope5" required name="modelo" placeholder="Ej. Camioneta 500 Kg. Ford F312" onChange={handleChange}/>
                </div>
                <div className="item-formulario">
                    <label htmlFor="placa" className="input-label bebas4">Placas*</label>
                    <input type="text" className="inputDarkGlass manrope5" required name="placa" placeholder="Ej. PYS-752-A" onChange={handleChange}/>
                </div>
                <div className="item-formulario">
                    <label htmlFor="poliza" className="input-label bebas4">Número de póliza*</label>
                    <input type="text" className="inputDarkGlass manrope5" required name="poliza" placeholder="Escriba el número de póliza" onChange={handleChange}/>
                </div>
                <div className="item-formulario espacio-extra">
                    ...
                    <input type="date" className="inputDarkGlass manrope5" required name="vencimientoPoliza" placeholder="Número a 10 dígitos" onChange={handleChange}/>
                </div>
...
export default FormularioAgregarUnidad
